...
# ╔═╡ 70df8840-089d-11ef-1d49-0f1bd8e362f9
using Symbolics

# ╔═╡ eda253fa-75eb-4b4a-9546-d5150d392750
@variables A[1:5, 1:3]

# ╔═╡ a5ee5ce6-aa3e-4dad-871a-8aeaeeb26724
@variables B[1:3, 1:3]


# ╔═╡ d319e897-8d73-4f0f-b588-657fe17c58df
A * B

# ╔═╡ c7db75ac-ea5a-4661-ac22-1f52ed946f79
a = Symbolics.variables(:a, 1:5, 1:3)

# ╔═╡ 05de721e-66d6-4fda-b899-8cb46f60e8a7
b = Symbolics.variables(:b, 1:3, 1:3)

# ╔═╡ 75b4bb0f-61ad-481a-8fe0-26dd68a3f6ee
a * b

# ╔═╡ e77daa86-58e0-43b0-86f8-148aa9b70fb7
N=8

# ╔═╡ 3a47da75-60f1-4dee-9b55-62b1b77c4070
@variables γ[N], β[N], ϵ, x[N]

# ╔═╡ a7ea5ae5-d594-4fc0-b20c-1605548a68ba
affine(gamma, beta, x) = (x .* gamma) .+ beta

# ╔═╡ 9569aeb5-b966-4582-bec9-948f8f8fea80
affine(γ, β, x)

# ╔═╡ 0a7010b4-5c3e-4cf8-b43e-577d9980f883
((x .* γ) .+ β)
...
manifest_format = "2.0"
project_hash = "df5c992e98977d426e8b635274846617e746cc63"
